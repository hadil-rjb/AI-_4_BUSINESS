...
<body>
    ...
    $questionId = $_GET['id']; // Supposons que l'ID suivant est l'ID actuel + 1
    ...
    $progress = (($questionId - 1) / $totalQuestions) * 100;
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-8 mb-4">
                                    <h5 class="card-title widget-card-title mb-3">Question :</h5>
                                    <h4 class="card-subtitle text-body-secondary m-0">
                                        <?= isset($question['question']) ? htmlspecialchars($question['question']) : ""; ?>
                                    </h4>
                                </div>
                                <div class="col-4">
                                ...
                                <?php if ($question) : ?>
                                    <form method="POST" action="Backend/submit.php?id=<?= htmlspecialchars($question['id']); ?>">
                                        <div class="form-group mb-4">
                                            <input type="text" placeholder="Entrer votre réponse" class="form-control" id="answer" name="answer" required>
                                        </div>
